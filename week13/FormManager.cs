...
namespace Week09Homework
{
    public partial class FormManager : Form
    {
        ...
        public FormManager()
        {
            ...
            OpenInfo(ref departments, DepartmentFullFileName); //ref : 변수의 주소를 넘김(C언어의 &)
            OpenInfo(ref professors, ProfessorFullFileName);
            OpenInfo(out students, StudentFullFileName);
        }
        ...
        private void OpenInfo(out Dictionary<string, Student> students, string filename) {
            students = new Dictionary<string, Student>(); //out -> 딕셔너리는 무조건 만들어줘야함
